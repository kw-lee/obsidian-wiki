<script lang="ts">
	...
	import { EditorView, keymap, placeholder, lineNumbers, highlightActiveLine, drawSelection, highlightActiveLineGutter } from '@codemirror/view';
	...
	const catppuccinHighlight = HighlightStyle.define([
		...
		{ tag: tags.heading3, color: 'var(--accent)', fontWeight: 'bold', fontSize: '1.1em' },
		...
		{ tag: tags.monospace, color: 'var(--success)', fontFamily: "'SF Mono', 'Fira Code', monospace" },
